...
def hello_world():
    ...
    if request_type_str == 'GET':
        return render_template('M12Q2.html', href2='')
    else:
        ...
        return render_template('M12Q2.html', href2='The suitable bread for you (age:'+str(myage)+' ,gender:'+str(mygender)+') is:'+predictions_to_str)
